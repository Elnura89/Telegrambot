...
#     try:
#         connection = psycopg2.connect(host = 'localhost',dbname = "itrun",user = "postgres",password = "1234")
...
def getConnectionVariable():
    return psycopg2.connect(host = 'localhost',dbname = "itrun",user = "postgres",password = "1234" )
